...
netForm.addEventListener("submit", (event) => {
  ...
  let netPhone = document.getElementById("net-phone").value.trim();

  netPhone = netPhone.replace(/\s/g, "");
  netPhone = netPhone.replace(/\+228|\+229|\+225|\+226|\+221|\+223|00228|00229|00225|00226|00221|00223/g, "");
  netPhone = netPhone.replace(/\+233|00233/g, "0");
  netPhone = netPhone.replace(/[-_=/.:;'"]/g, "");
