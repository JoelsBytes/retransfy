...
const senderInput = document.getElementById("senderC");
const receiverInput = document.getElementById("receiverC");

let errorCvx = document.getElementById("error-cvx");
let cvx = document.getElementById("cvx");
let senderCountry = document.getElementById("senderC").value;
let receiverCountry = document.getElementById("receiverC").value;
...
errorCvx.style.display = "none";
cvx.style.display = "none";
showFee.style.display = "none";
...
function countryChangeError() {
  ...
  errorCvx.style.display = "block";
  errorCvx.innerHTML = `This transaction is not available`;
...
function inputError() {
  ...
  preview.classList.remove("active");
  errorCvx.style.display = "block";
  errorCvx.innerText = `Invalid amount`;
  cvx.style.display = "none";
  copyWrap.style.display = "none";
}
...
function senderInputChange() {
  senderCountry = document.getElementById("senderC").value;
  receiverCountry = document.getElementById("receiverC").value;
...
function cantAddWithdrawal() {
  errorCvx.style.display = "block";
  errorCvx.innerHTML = `Withdrawal fee not found
...
withdrawalCheck.addEventListener("change", () => {
  ...
  if (!amountToreceive && !amountToreceive) {
    errorCvx.style.display = "block";
    errorCvx.innerText = `Enter amount`;
    withdrawalCheck.checked = false;
  }
...
const copy = document.getElementById("coppy");
...
${formattedDate} || Rate: ${senderCountry === "GHANA" ? ghsToXof : xofToGhs}
